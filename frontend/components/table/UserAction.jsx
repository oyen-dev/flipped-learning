...
const UserAction = () => {
  ...
  return (
    <div className="flex items-center justify-center space-x-5">
      <div>
        <label htmlFor="my-modal-view" className="btn modal-button bg-sky-600 border-none">
          <svg
      ...
      <div>
        <label htmlFor="my-modal-update" className="btn modal-button bg-emerald-600 border-none">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="16"
            height="16"
