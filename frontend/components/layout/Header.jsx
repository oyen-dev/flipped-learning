...
const Header = ({ children }) => {
  ...
  return (
    <div className="w-full flex items-center justify-between h-14 text-white z-10 bg-gray-800">
      {/* Left empty space */}
      <div className="flex items-center justify-start md:justify-center pl-3 w-16 lg:w-64 h-full bg-gray-800 border-none" />
      ...
      <div className="flex flex-col header-right h-full justify-center">
        ...
        <div className="flex w-full justify-between px-2 py-1">
          <p className="mb-0 font-semibold text-lg">Flipped Learning</p>
          <div className="flex flex-row items-center justify-items-center mb-0 space-x-6">
            <button onClick={handleTheme}>
              {theme
                ...
                <svg
                  ...
                  height="20"
                  fill="currentColor"
                  className="hover:fill-blue-500 duration-150"
                  viewBox="0 0 16 16"
                >
            ...
            <button className="flex flex-row items-center space-x-2 group">
              <svg
                ...
                height="20"
                fill="currentColor"
                className="group-hover:fill-blue-500 duration-150"
                viewBox="0 0 16 16"
              >
                <path
                  fillRule="evenodd"
              ...
              <p className="mb-0 group-hover:text-blue-500 duration-150">
                Log Out
              </p>
            </button>
          </div>
