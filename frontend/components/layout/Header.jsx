    ...
    <div className="w-full flex items-center justify-between h-14 text-white z-10 bg-[#accbe1] dark:bg-gray-900 transition-all ease-in-out duration-300">
      ...
      <div className="flex flex-col header-right h-full justify-center">
        ...
        <div className="flex w-full justify-between px-2 py-1">
          <p className="mb-0 font-semibold text-lg text-gray-900 dark:text-white duration-300 ease-in-out">Flipped Learning</p>
          <div className="flex flex-row items-center justify-items-center mb-0 space-x-6">
            <button onClick={handleTheme}>
              {themeValue
                ...
                <svg
                  ...
                  height="20"
                  fill="currentColor"
                  className="hover:fill-blue-500 fill-gray-900 dark:fill-white duration-300 ease-in-out"
                  viewBox="0 0 16 16"
                >
                ...
                <svg
                  ...
                  height="20"
                  fill="currentColor"
                  className="fill-gray-900 dark:fill-white hover:fill-blue-500 duration-300 ease-in-out"
                  viewBox="0 0 16 16"
                >
            ...
            <button className="flex flex-row items-center space-x-2 group">
              <svg
                ...
                height="20"
                fill="currentColor"
                className="fill-gray-900 dark:fill-white group-hover:fill-blue-500 duration-300 ease-in-out"
                viewBox="0 0 16 16"
              >
                <path
                  fillRule="evenodd"
