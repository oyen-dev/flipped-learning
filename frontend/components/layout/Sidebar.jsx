      ...
      <div className="overflow-y-auto overflow-x-hidden flex flex-col justify-between flex-grow">
        <ul className="flex flex-col py-4 space-y-1">
          <li>
            ...
            <img className="md:w-[70%] md:ml-7 w-[40%] ml-4  rounded-full overflow-hidden" src="https://therminic2018.eu/wp-content/uploads/2018/07/dummy-avatar.jpg" />

            <div className="flex flex-row items-center h-4 md:h-8">
              <div className="text-sm font-light tracking-wide text-gray-400 hidden">
                Budi Tono, S.Pd., M.Pd.
              </div>
            </div>
          </li>
