      ...
      <div className="flex flex-col w-full h-44 items-start justify-between bg-[url('/images/class.jpg')] bg-center object-contain object-center px-3 py-3 rounded-md">
        <div className="flex w-full items-center justify-end">
          ...
          >
            ...
            <ul tabIndex={0} className="dropdown-content menu rounded-md p-2 shadow bg-gray-700">
              <li className="whitespace-nowrap"><a>Edit Kelas</a></li>
              <li className="whitespace-nowrap"><a>Arsipkan Kelas</a></li>
              <li className="whitespace-nowrap"><a>Hapus Kelas</a></li>
            </ul>
          </div>
        </div>
