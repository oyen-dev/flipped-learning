          ...
          ? (
            <div className='flex flex-col space-y-2 w-full'>
              ...
              <div className="flex justify-end items-end">
                {submission.points === null
                  ? <Link
                  to={`tasks/${postId}/submissions/edit`} className='flex flex-row space-x-2 items-center justify-center py-1 px-4 font-normal md:py-2 md:px-4 md:font-medium text-white bg-blue-600 hover:text-white hover:bg-blue-800 rounded-lg duration-300 ease-in-out'>
