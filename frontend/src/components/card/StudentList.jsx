...
const StudentList = (props) => {
  ...
  return (
    <div className="flex flex-row items-center justify-between w-full px-2 py-2 rounded-lg bg-[#e9ecef] dark:bg-gray-700 transition-all ease-in-out duration-300">
        <Link to={`/user/students/${_id}`} className="flex flex-row space-x-4 items-center">
            ...
            {/* Student name */}
            <span
              className="text-sm lg:text-base font-semibold text-black dark:text-white hover:text-blue-500 duration-150 ease-in-out"
            >
              {fullName}
            </span>
        </Link>
