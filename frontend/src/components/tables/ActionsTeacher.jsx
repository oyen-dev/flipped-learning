import { TeacherProfile, UpdateTeacher } from '../../components/modals'
      ...
      <div className="flex items-center justify-center space-x-5">
        ...
        <div>
          <label
            ...
            className="btn modal-button bg-sky-600 border-none"
          >
            <svg
        ...
        <div>
          <label
            ...
            className="btn modal-button bg-emerald-600 border-none"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="16"
        ...
        <div>
          <label
            className="btn modal-button bg-red-600 border-none"
            onClick={() =>
              MySwal.fire({
                title: 'Konfirmasi Hapus',
                text: 'Apakah Anda akan menghapus data Bagiya Hardiansyah?',
                icon: 'warning',
