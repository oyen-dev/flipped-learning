  ...
  return (
    ...
    >
      <div className="w-full grid auto-rows-auto lg:grid-cols-2 gap-5">
        <div className="flex flex-col w-full items-center lg:items-start justify-start text-gray-900 dark:text-white bg-sky-200 dark:bg-gray-900 transition-all ease-in-out duration-300 px-5 py-5 rounded-lg">
